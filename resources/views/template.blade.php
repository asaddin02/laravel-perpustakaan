...
<body>
            ...
            <div class="brand-logo">
                <a href="/dashboard">
                    ...
                    <span class="brand-title">
                        <img src="{{ asset('quixlab-master/images/logo-text.png') }}" alt="">
                    </span>
                </a>
            </div>
        </div>
                    ...
                    <ul class="clearfix">
                                    ...
                                    <ul>
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="{{ asset('quixlab-master/images/avatar/1.jpg') }}" alt="">
                                        ...
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="{{ asset('quixlab-master/images/avatar/2.jpg') }}" alt="">
                                                <div class="notification-content">
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="{{ asset('quixlab-master/images/avatar/3.jpg') }}" alt="">
                                                <div class="notification-content">
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="{{ asset('quixlab-master/images/avatar/4.jpg') }}" alt="">
                                                <div class="notification-content">
                        ...
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative"   data-toggle="dropdown">
                                ...
                                <img src="{{ asset('quixlab-master/images/user/1.png') }}" height="40" width="40" alt="">
                            </div>
    ...
    ***********************************-->
    ...
    <script src="{{ asset('quixlab-master/./plugins/chartist-plugin-tooltips/js/chartist-plugin-tooltip.min.js') }}"></script>
